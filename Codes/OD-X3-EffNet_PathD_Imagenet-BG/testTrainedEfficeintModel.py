...
#
input_shape = (240,240)
test_dir=r'C:\PyProjects\Vasculitis\Data\TestData\patches_bg'
...
###################################################################
loaded_model = tensorflow.keras.models.load_model('TwoStep_pathologydataset_Ourdataset_best_model.epoch33-Loss0.18.hdf5')
